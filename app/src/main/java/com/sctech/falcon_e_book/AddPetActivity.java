...
public class AddPetActivity extends AppCompatActivity  implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AddPetActivity.this, ShowDataActivity.class);
    ...
    private void savePet() {
        ...
        if (TextUtils.isEmpty(nameString)) {
            Toast.makeText(this, "pet name should not be blanks", Toast.LENGTH_SHORT).show();
            return;
        }

        if (TextUtils.isEmpty(weightString)) { //default to 0
            weightString = "0";
        }
